...
INSERT INTO `products` VALUES (1,'Foam Dinner Plate',70,1.21),(2,'Pork - Bacon,back Peameal',49,4.65),(3,'Lettuce - Romaine, Heart',38,3.35),(4,'Brocolinni - Gaylan, Chinese',90,4.53),(5,'Sauce - Ranch Dressing',94,1.63),(6,'Petit Baguette',14,2.39),(7,'Sweet Pea Sprouts',98,3.29),(8,'Island Oasis - Raspberry',26,0.74),(9,'Longan',67,2.26),(10,'Broom - Push',6,1.09),(17,'product1',1,1.00);
/*!40000 ALTER TABLE `products` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `products_archieve`
--

DROP TABLE IF EXISTS `products_archieve`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `products_archieve` (
...
--
-- Dumping data for table `products_archieve`
--

LOCK TABLES `products_archieve` WRITE;
/*!40000 ALTER TABLE `products_archieve` DISABLE KEYS */;
INSERT INTO `products_archieve` VALUES (1,'Foam Dinner Plate',70,1.21),(2,'Pork - Bacon,back Peameal',49,4.65),(3,'Lettuce - Romaine, Heart',38,3.35),(4,'Brocolinni - Gaylan, Chinese',90,4.53),(5,'Sauce - Ranch Dressing',94,1.63),(6,'Petit Baguette',14,2.39),(7,'Sweet Pea Sprouts',98,3.29),(8,'Island Oasis - Raspberry',26,0.74),(9,'Longan',67,2.26),(10,'Broom - Push',6,1.09),(17,'product1',1,1.00);
/*!40000 ALTER TABLE `products_archieve` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-10-03 15:56:15
